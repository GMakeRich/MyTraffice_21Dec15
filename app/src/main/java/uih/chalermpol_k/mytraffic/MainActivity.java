...
public class MainActivity extends AppCompatActivity {
    ...
    private void listViewController() {
        ...
        strTitle[0] = "หัวข้อ 8";
        strTitle[0] = "หัวข้อ 9";
        strTitle[0] = "หัวข้อ 10";
        strTitle[0] = "หัวข้อ 11";
        strTitle[0] = "หัวข้อ 12";
        strTitle[0] = "หัวข้อ 13";
        strTitle[0] = "หัวข้อ 14";
        strTitle[0] = "หัวข้อ 15";
        strTitle[0] = "หัวข้อ 16";
        strTitle[0] = "หัวข้อ 17";
        strTitle[0] = "หัวข้อ 18";
        strTitle[0] = "หัวข้อ 19";
        strTitle[0] = "หัวข้อ 20";
        //#3
